...
-- 1. Drop existing tables in the reverse order of foreign keys to avoid blockages
...
-- 4. Create sessions table schema
...
-- 5. Create registrations table schema
...
-- 6. Create feedback table schema
