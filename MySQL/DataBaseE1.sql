-- 1. Create a fresh, isolated database
CREATE DATABASE CommunityPortalDB;
...
-- 3. Create the Events table schema
CREATE TABLE Events (
...
-- 4. Create the Registrations junction table schema
...
(2, 'AI & ML Conference', 'Conference on AI advancements.', 'Chicago', '2025-05-15 09:00:00', '2025-05-15 17:00:00', 'completed', 3);
